...
const HERO_FLOW = [
  ...
  {
    title: "Smart Mix",
    text: "Generate ranked 3Г—3 candidates with calm guardrails.",
  },
  {
    title: "Export",
...
const HERO_STATS = ["9 ordered images", "4 ranked candidates", "ZIP + captions + CSV"] as const;
...
export default function Marketing() {
  ...
  const railIsDark = activeSection === "top" || activeSection === "story";
...
>
  ...
  className={[
    ...
    isActive ? `${railDotActive} scale-110` : railDotIdle,
      ...
      {/* MODULES (dark) */}
      <section id="system-logic" className="relative overflow-hidden border-y border-white/[0.08] bg-[#071018] px-6 py-20 md:px-10 lg:px-14 lg:py-24">
  <div className="pointer-events-none absolute inset-0">
    <div className="absolute inset-0 bg-[radial-gradient(circle_at_22%_28%,rgba(255,255,255,0.055),transparent_30%),radial-gradient(circle_at_78%_52%,rgba(120,140,255,0.045),transparent_30%)]" />
    <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/18 to-transparent" />
    <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
  </div>

  <div className="relative mx-auto grid w-full max-w-[1180px] gap-12 lg:grid-cols-[0.88fr_1.12fr] lg:items-start">
    <div>
      <div className="mb-5 inline-flex rounded-full border border-white/10 bg-white/[0.045] px-3 py-1 text-[11px] uppercase tracking-[0.18em] text-white/45">
        Operating logic
      </div>

      <h2 className="max-w-[12ch] text-[clamp(2.1rem,3.8vw,4rem)] font-medium leading-[0.94] tracking-[-0.055em] text-white">
        The calm is in the guardrails.
      </h2>

      <p className="mt-6 max-w-[38rem] text-[15px] leading-7 text-white/58">
        CreatorOps does not add another layer of noise. It narrows the decision space before anything gets exported.
      </p>

      <div className="mt-8 grid max-w-[38rem] gap-3">
        <div className="flex gap-4 rounded-[22px] border border-white/10 bg-white/[0.04] p-4">
          <div className="mt-1 h-2 w-2 shrink-0 rounded-full bg-white/28" />
          <div>
            <div className="text-[14px] font-medium text-white">Fewer candidates</div>
            <p className="mt-1 text-[13px] leading-6 text-white/46">
              The user does not sort an endless library. The system reduces the field to a usable set.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 rounded-[22px] border border-white/10 bg-white/[0.04] p-4">
          <div className="mt-1 h-2 w-2 shrink-0 rounded-full bg-white/28" />
          <div>
            <div className="text-[14px] font-medium text-white">Visible reasoning</div>
            <p className="mt-1 text-[13px] leading-6 text-white/46">
              Smart Mix exposes simple reasons: balance, variety, duplicates avoided, and readiness.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 rounded-[22px] border border-white/10 bg-white/[0.04] p-4">
          <div className="mt-1 h-2 w-2 shrink-0 rounded-full bg-white/28" />
          <div>
            <div className="text-[14px] font-medium text-white">One clean contract</div>
            <p className="mt-1 text-[13px] leading-6 text-white/46">
              The final state is not a moodboard. It becomes a downloadable pack with files, captions, CSV, and handoff notes.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="relative">
      <div className="pointer-events-none absolute -inset-8 rounded-[44px] bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.08),transparent_60%)] blur-3xl" />

      <div className="relative rounded-[34px] border border-white/10 bg-[#0b1119]/82 p-5 shadow-[0_22px_90px_rgba(0,0,0,0.38)] backdrop-blur-xl">
        <div className="mb-6 flex items-center justify-between gap-4">
          ...
          <div className="rounded-full border border-white/10 bg-white/[0.055] px-3 py-1 text-[11px] text-white/50">
            Beta logic
          </div>
        </div>

        <div className="grid gap-3">
          <div className="grid grid-cols-[92px_1fr_auto] items-center gap-4 rounded-[20px] border border-white/10 bg-white/[0.04] px-4 py-3">
            <div className="text-[11px] uppercase tracking-[0.16em] text-white/32">Rule 01</div>
            <div>
              <div className="text-[14px] font-medium text-white">No near-duplicates</div>
              <div className="mt-1 text-[12px] text-white/42">Avoid repeating the same visual beat.</div>
            </div>
            <div className="rounded-full border border-white/10 bg-white/[0.045] px-2.5 py-1 text-[10px] text-white/45">
              active
            </div>
          </div>

          <div className="grid grid-cols-[92px_1fr_auto] items-center gap-4 rounded-[20px] border border-white/10 bg-white/[0.04] px-4 py-3">
            <div className="text-[11px] uppercase tracking-[0.16em] text-white/32">Rule 02</div>
            <div>
              <div className="text-[14px] font-medium text-white">Balance the rhythm</div>
              <div className="mt-1 text-[12px] text-white/42">Mix tone, series, and intensity before planning.</div>
            </div>
            <div className="rounded-full border border-white/10 bg-white/[0.045] px-2.5 py-1 text-[10px] text-white/45">
              active
            </div>
          ...
          <div className="grid grid-cols-[92px_1fr_auto] items-center gap-4 rounded-[20px] border border-white/10 bg-white/[0.04] px-4 py-3">
            <div className="text-[11px] uppercase tracking-[0.16em] text-white/32">Rule 03</div>
            <div>
              <div className="text-[14px] font-medium text-white">Explain the pick</div>
              <div className="mt-1 text-[12px] text-white/42">Show why a mix is useful before export.</div>
            </div>
            <div className="rounded-full border border-white/10 bg-white/[0.045] px-2.5 py-1 text-[10px] text-white/45">
              active
            </div>
        ...
        <div className="mt-5 rounded-[24px] border border-white/10 bg-[#080d14] p-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="rounded-full border border-white/10 bg-white/[0.055] px-3 py-1 text-[10px] text-white/45">
              export-first
            </div>
          </div>

          <div className="mt-4 grid gap-2 sm:grid-cols-2">
            <div className="rounded-[16px] border border-white/10 bg-white/[0.035] px-3 py-3 text-[12px] text-white/52">
              ordered images
            </div>
            <div className="rounded-[16px] border border-white/10 bg-white/[0.035] px-3 py-3 text-[12px] text-white/52">
              captions
