      ...
      >
        ...
        <div className="relative mx-auto grid w-full max-w-[1180px] gap-16 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          ...
          <div className="relative min-h-[520px]">
            <div className="pointer-events-none absolute inset-0">
              <div className="absolute left-[10%] top-[18%] h-[64%] w-px bg-gradient-to-b from-transparent via-white/16 to-transparent" />
              <div className="absolute left-[10%] top-[50%] h-px w-[78%] bg-gradient-to-r from-white/18 via-white/10 to-transparent" />
              <div className="absolute left-[34%] top-[30%] h-px w-[42%] rotate-[-18deg] bg-gradient-to-r from-transparent via-white/10 to-transparent" />
              <div className="absolute left-[36%] top-[68%] h-px w-[38%] rotate-[14deg] bg-gradient-to-r from-transparent via-white/10 to-transparent" />

              <div className="absolute left-[5%] top-[44%] h-3 w-3 rounded-full border border-white/18 bg-white/[0.04] shadow-[0_0_42px_rgba(255,255,255,0.18)]" />
              <div className="absolute left-[48%] top-[27%] h-2 w-2 rounded-full bg-white/24 shadow-[0_0_34px_rgba(255,255,255,0.18)]" />
              <div className="absolute right-[14%] top-[50%] h-3 w-3 rounded-full border border-white/18 bg-white/[0.04] shadow-[0_0_46px_rgba(255,255,255,0.18)]" />
              <div className="absolute left-[54%] bottom-[18%] h-2 w-2 rounded-full bg-white/20 shadow-[0_0_32px_rgba(255,255,255,0.16)]" />

              <div className="absolute left-[18%] top-[22%] h-48 w-48 rounded-full bg-white/[0.035] blur-3xl" />
              <div className="absolute right-[8%] top-[38%] h-56 w-56 rounded-full bg-white/[0.025] blur-3xl" />
            </div>

            <div className="absolute left-[4%] top-[10%] max-w-[18rem]">
              <div className="text-[11px] uppercase tracking-[0.22em] text-white/28">
                Input field
              </div>
              <div className="mt-3 text-[18px] font-medium leading-[1.05] tracking-[-0.035em] text-white/82">
                Many assets enter.
              </div>
            ...
            <div className="absolute right-[2%] top-[36%] max-w-[19rem]">
              <div className="text-[11px] uppercase tracking-[0.22em] text-white/28">
                Guardrail layer
              </div>
              <div className="mt-3 text-[18px] font-medium leading-[1.05] tracking-[-0.035em] text-white/82">
            ...
            <div className="absolute bottom-[8%] left-[24%] max-w-[24rem]">
              <div className="text-[11px] uppercase tracking-[0.22em] text-white/28">
                Output contract
              </div>
              <div className="mt-3 text-[22px] font-medium leading-[1.02] tracking-[-0.045em] text-white/88">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                <span className="rounded-full border border-white/10 bg-white/[0.035] px-3 py-1.5 text-[11px] text-white/42">
                  images
                </span>
                <span className="rounded-full border border-white/10 bg-white/[0.035] px-3 py-1.5 text-[11px] text-white/42">
                  captions
